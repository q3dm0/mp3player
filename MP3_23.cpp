...
{
AnsiString file = "log.bin";
AnsiString temp =  TrackBar2->Position;
...
String file2;
TStringList *list1 = new TStringList;
list1->LoadFromFile("log.bin");
file2 = list1->Strings[0];
Edit1->Text = file2;
TrackBar2->Position = Edit1->Text.ToInt();
delete list1;
}
//---------------------------------------------------------------------------
